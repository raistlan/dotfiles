...
Primary local tasks: **building new features** and **reviewing PRs and branches** in the Headway monorepo. Locally I prefer a minimal set of MCPs; reserve MCP-heavy workflows for Cloud agents.
